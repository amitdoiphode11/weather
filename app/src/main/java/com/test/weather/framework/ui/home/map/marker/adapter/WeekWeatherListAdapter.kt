package com.test.weather.framework.ui.home.map.marker.adapter
...
class WeekWeatherListAdapter(
    ...
    internal inner class OutletViewHolder(var view: View) : RecyclerView.ViewHolder(view),
        ...
        fun onBind(weCurrentWeather: WeCurrentWeather?) {
            ...
            view.tv_date.text = weCurrentWeather?.dt?.let { convertLongToDateTime(it) }
        }
    ...
    fun convertLongToDateTime(dateTime: Long): String? {
